...
{: .recommendedtools }  
> [mcasset.cloud](https://mcasset.cloud) is a great for exploreing and extracting vanilla assets.  
> [Blockbench](https://www.blockbench.net) is a great for creating and editing minecraft textures.   
